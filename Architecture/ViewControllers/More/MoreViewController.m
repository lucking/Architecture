...
-(void)myBtnClick:(UIButton*)Btn{
	...
	if (Btn.tag==101) {    //
        [[NSNotificationCenter defaultCenter] postNotificationName:@"loginSuccess" object:@"0"];
        
	}
	else if (Btn.tag==102){//
		//[[NSNotificationCenter defaultCenter] postNotificationName:@"BackToFirst" object:@"0"];
        //[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(BackToFirst) name:@"0" object:nil];
