...
- (CAShapeLayer *)outterLayer
{
    if (_outterLayer==nil) {
        ...
        _outterLayer.fillColor = BGCOLOR.CGColor;
...
- (CAShapeLayer *)triangleLayer
{
    if (_triangleLayer==nil) {
        ...
        _triangleLayer.fillColor = SELECTCOLORBIG.CGColor;
...
- (void)selectUI
{
    self.innerLayer.fillColor    = SELECTCOLORBIG.CGColor;
    self.outterLayer.strokeColor = SELECTCOLORBIG.CGColor;
}
